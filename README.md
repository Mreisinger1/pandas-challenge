...
I used jupyter notebook to complete this assignment. I was able to use class notes along with class examples to solve most of the requirements. I am still confused on the last 2-3 parts and will request more help from a TA. I also requested an extention on this assignment. 
